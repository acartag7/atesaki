...
| 2026-09-08 | B4 algorithm wording corrected mechanically: compare the token header with the configured algorithm and key type; the token does not select the allowed set. No new policy ruling. | Packet 14 item 13; dispatch: "Packet 14 item 13's B4 alg wording is identified by the packet as mechanical and needing no ruling. It can proceed independently if still outstanding." |
| 2026-09-08 | #54: Go configuration validator with drift checks; logical record schemas generated from Go types. Reverses only the configuration-schema half of #36. | Words: "#54: Approved as proposed. Keep the Go parser as the configuration validator, drop the separate configuration JSON Schema, add the specified drift checks, and generate logical record schemas from Go record types." |
| 2026-09-08 | #67: machine clients deferred to v0.1; signed proxy assertions retained in v0. No deferral of sweeper, retention purge or proxied CIMD. | Words: "#67: Defer machine clients to v0.1. Keep signed proxy assertions in v0. This ruling does not defer the sweeper, retention purge, or proxied CIMD." |
| 2026-09-08 | #24 authority model approved; prerequisite receipt only here. Packet 12 owns the G13/B1 contract completion. | Words: "#24: Approve the proposed single-operator authority model, including operator visibility of purpose and the stated shared-UID/self-approval residual. Human labels remain evidence only, never authority." |
| 2026-09-08 | #53: catalog narrowing followed by the existing group ceiling; distinct empty-result errors; narrowed scopes returned and raw requested scopes retained separately. | Words: "#53: Approve catalog narrowing followed by the existing group ceiling, preserving their distinct empty-result errors. Return narrowed scopes and preserve raw requested scopes separately." |
| 2026-09-08 | #62 consent-page carrier direction only. C1/C2, claim-state details and AS readiness are held; #62 remains open. | Words: "#62: Approve the consent-page carrier direction only. Hold C1/C2 and claim-state details. Do not mark the whole question closed or treat the authorization-server contract as ready." |
| 2026-09-08 | Pending receipt page direction only; final timeout, callback, abandonment and repeat-visit contract held. | Words: "Pending receipt page: approve the design direction, but hold the final contract until its timeout, callback, abandonment, and repeat-visit behavior are specified." |
| 2026-09-08 | Explicit request-ID selection deferred. One bounded design is required; approved-content hash and authority checks remain constraints, not permission to change the claim flow. | Words: "Explicit request-ID selection: defer the ruling. Finish one bounded design covering the receipt page, selection, locked confirmation, concurrent claim loser, and lost-response behavior. Preserve the approved-content hash and all authority checks. Show the complete path from pending request to a successful tool call, and exactly where failure requires a new approval. No implementation." |
| 2026-09-08 | Production browser headers and #5 remain undecided. | Words: "Production browser headers and #5 remain undecided." |
